...
<body class="body">
    ...
    <main>
        ...
        <section id="#achivements">
            ...
            <ol><?php
            $spisok = ["Ну конечно же главное достижение это данный сайт.","Но так же могу похвастаться двумя золотыми
                    медалями и красным аттестатом из 11-ого класса.","А еще у меня красивая собака."]
            ?>
                <li><?php
                    echo $spisok[0];
                ?></li>
